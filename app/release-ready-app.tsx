  ...
  return (
    <div className="min-h-[100dvh] text-white flex flex-col relative overflow-hidden" dir="ltr">
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#FFD700]/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 left-1/3 w-[400px] h-[400px] bg-[#FFD700]/5 rounded-full blur-[100px]" />
      </div>
